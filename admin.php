...
if ($ses_explode[2] == 3) {
  header("Location: ../reboost/pelanggan.php");
}
      ...
      <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
          <ul class="navbar-nav mr-auto ">
            ...
            <li class="nav-item d-lg-none">
              <a class="nav-link text-white" href="?menu=datapemasukan">Laporan Pemasukan</a>
            </li>
            <li class="nav-item d-lg-none">
              <a class="nav-link text-white" href="?menu=inputpenjualan">Input Penjualan</a>
            </li>
            <li class="nav-item d-lg-none">
              <a class="nav-link text-white" href="?menu=laporanpenjualan">Laporan Penjualan</a>
            </li>
            <li class="nav-item d-lg-none">
              <a class="nav-link text-white" href="?menu=datapegawai">Data Pegawai</a>
            </li>
            <li class="nav-item d-lg-none">
              <a class="nav-link text-white" href="?menu=datapelanggan">Data Pelanggan</a>
            </li>
            <li class="nav-item d-lg-none">
              <a class="nav-link text-white" href="?menu=datadistributor">Data Distributor</a>
            </li>
          </ul>
      ...
      <div class="row">
        <nav class="col-sm-3 col-md-2 d-none d-sm-block bg-secondary sidebar" style="position: fixed;height:780px">
          <ul class="nav nav-pills flex-column">
            ...
            <li class="nav-item">
              <div class="nav-link active bg-dark">Penjualan Buku</div>
            </li>
            <li class="nav-item">
              <a class="nav-link text-white" href="?menu=inputpenjualan">Input Penjualan</a>
            </li>
            ...
            <li class="nav-item">
              <div class="nav-link active bg-dark">Pengguna</div>
            </li>
            <li class="nav-item">
              <a class="nav-link text-white" href="?menu=datapegawai">Data Pegawai</a>
            </li>
            ...
            <li class="nav-item">
              <div class="nav-link active bg-dark">Distributor</div>
            </li>
            <li class="nav-item">
              <a class="nav-link text-white" href="?menu=datadistributor">Data Distributor</a>
            </li>
          ...
          <?php
            ...
            switch ($_GET['menu']) {
              ...
              case 'datapelanggan':
                ...
                break;
              case 'editpelanggan':
                include 'menu/editpelanggan.php';
                break;
              case 'hapuspelanggan':
                include 'menu/hapuspelanggan.php';
                break;
              case 'datadistributor':
                include 'menu/datadistributor.php';
                break;
              case 'editdistributor':
                include 'menu/editdistributor.php';
                break;
              case 'jual':
              ...
              case 'loadbuku':
                ...
                break;
              case 'pasok':
                include 'menu/pasok.php';
                break;
              case 'selesai':
                include 'menu/hapuskeranjang.php';
                break;
              default:
